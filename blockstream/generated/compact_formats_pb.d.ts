...
export class ChainMetadata extends jspb.Message {
  getSaplingcommitmenttreesize(): number;
  setSaplingcommitmenttreesize(value: number): ChainMetadata;

  getOrchardcommitmenttreesize(): number;
  setOrchardcommitmenttreesize(value: number): ChainMetadata;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ChainMetadata.AsObject;
  static toObject(includeInstance: boolean, msg: ChainMetadata): ChainMetadata.AsObject;
  static serializeBinaryToWriter(message: ChainMetadata, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ChainMetadata;
  static deserializeBinaryFromReader(message: ChainMetadata, reader: jspb.BinaryReader): ChainMetadata;
}
...
export class CompactBlock extends jspb.Message {
  ...
  getChainmetadata(): ChainMetadata | undefined;
  setChainmetadata(value?: ChainMetadata): CompactBlock;
  hasChainmetadata(): boolean;
  clearChainmetadata(): CompactBlock;
...
export namespace CompactBlock {
  export type AsObject = {
    ...
    chainmetadata?: ChainMetadata.AsObject,
  }
}
...
export class CompactSaplingOutput extends jspb.Message {
  ...
  setEphemeralkey(value: Uint8Array | string): CompactSaplingOutput;
