...
export class GetSubtreeRootsArg extends jspb.Message {
  getStartindex(): number;
  setStartindex(value: number): GetSubtreeRootsArg;

  getShieldedprotocol(): ShieldedProtocol;
  setShieldedprotocol(value: ShieldedProtocol): GetSubtreeRootsArg;

  getMaxentries(): number;
  setMaxentries(value: number): GetSubtreeRootsArg;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetSubtreeRootsArg.AsObject;
  static toObject(includeInstance: boolean, msg: GetSubtreeRootsArg): GetSubtreeRootsArg.AsObject;
  static serializeBinaryToWriter(message: GetSubtreeRootsArg, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetSubtreeRootsArg;
  static deserializeBinaryFromReader(message: GetSubtreeRootsArg, reader: jspb.BinaryReader): GetSubtreeRootsArg;
}

export namespace GetSubtreeRootsArg {
  export type AsObject = {
    startindex: number,
...
export class SubtreeRoot extends jspb.Message {
  getRoothash(): Uint8Array | string;
  getRoothash_asU8(): Uint8Array;
  getRoothash_asB64(): string;
  setRoothash(value: Uint8Array | string): SubtreeRoot;

  getCompletingblockhash(): Uint8Array | string;
  getCompletingblockhash_asU8(): Uint8Array;
  getCompletingblockhash_asB64(): string;
  setCompletingblockhash(value: Uint8Array | string): SubtreeRoot;

  getCompletingblockheight(): number;
  setCompletingblockheight(value: number): SubtreeRoot;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SubtreeRoot.AsObject;
  static toObject(includeInstance: boolean, msg: SubtreeRoot): SubtreeRoot.AsObject;
  static serializeBinaryToWriter(message: SubtreeRoot, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SubtreeRoot;
  static deserializeBinaryFromReader(message: SubtreeRoot, reader: jspb.BinaryReader): SubtreeRoot;
}

export namespace SubtreeRoot {
  export type AsObject = {
    roothash: Uint8Array | string,
    completingblockhash: Uint8Array | string,
