...
generate-pb-js:
    ...
    protoc -I=./src/protos service.proto compact_formats.proto --js_out=import_style=commonjs:./blockstream/generated --grpc-web_out=import_style=commonjs,mode=grpcwebtext:./blockstream/generated
