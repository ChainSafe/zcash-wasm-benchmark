...
// This build script is mostly copied from librustzcash

const COMPACT_FORMATS_PROTO: &str = "protos/compact_formats.proto";

const SERVICE_PROTO: &str = "protos/service.proto";
...
fn build() -> io::Result<()> {
    ...
    tonic_build::configure()
        ...
        // )
        .type_attribute(".cash.z.wallet.sdk.rpc.ChainMetadata", "#[derive(Debug)]")
        .extern_path(
